...
class CalculadoraErrosGUI(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("calculator.png")) # Opcional: adicione um ícone
        self.setGeometry(100, 100, 700, 650) # Aumentei um pouco a altura para melhor espaçamento
    ...
    def init_calculadora_ui(self):
        ...
        self.calc_trunc = QRadioButton("Truncamento")
        self.calc_arred = QRadioButton("Arredondamento")
        self.calc_arred.setChecked(True)
        ...
        self.calc_valor1_aprox = QLineEdit()
        self.calc_valor2_aprox = QLineEdit()
        self.calc_res_exato = QLineEdit()
        self.calc_res_aprox = QLineEdit()
        self.calc_erro_abs = QLineEdit()
        self.calc_erro_rel = QLineEdit()
    ...
    def calcular(self, op_str):
        try:
            ...
            if erro_rel.is_finite():
                # Formata com até 10 casas decimais, removendo zeros desnecessários
    ...
    def init_simulacao_ui(self):
        layout = QVBoxLayout(self.tab_simulacao)

        # Grupo de parâmetros
        params_group = QGroupBox("Parâmetros da Simulação")
        params_layout = QFormLayout()

        self.sim_valor = QLineEdit("0.0001")
        self.sim_vezes = QSpinBox()
        self.sim_vezes.setRange(1, 100000)
        self.sim_vezes.setValue(100)
        self.sim_digitos = QSpinBox()
        self.sim_digitos.setRange(1, 50)
        self.sim_digitos.setValue(3)
        ...
        self.sim_run_btn.clicked.connect(self.rodar_simulacao)
        ...
        self.sim_log.setFont(QFont("JetBrains Mono", 10))
    ...
    def rodar_simulacao(self):
        try:
            ...
            for i in range(1, vezes + 1):
                ...
                # Para não sobrecarregar a GUI, mostramos apenas os primeiros 100 passos
                if i <= 100:
...
if __name__ == '__main__':
    ...
    app.setStyleSheet(STYLESHEET) # Aplica o estilo
    window = CalculadoraErrosGUI()
    window.show()
    sys.exit(app.exec())
